...
**Fig. 1:** *Taken from Southworth et al., (2020): TESS light curve of V453 Cyg. The PDC data is given in grey and the SAP in the remaining six colors. The colors indicate the devision of the data into the six sets for the polynomial normalization functions.*

![dmpp1](images/dmpp1.png)

**Fig. 2:** *Taken from Jones et al., (2020): a) TESS Sector 6 SAP flux of DMPP-1, b) the PDC light curve, c) the PDC flux light curve after sigma clipping (blue) and the mean Gaussian Process function (red), d) the cleaned, de-tended and normalized PDC flux used for transit searches.*
