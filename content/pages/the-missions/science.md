...
Pinsonneault
  ...
  <td>
THE APOGEE-KEPLER RED GIANT PROJECT: A TREASURY FOR STELLAR POPULATION
AND STELLAR PHYSICS STUDIES
</td>
  <td>
<a href="data/keplergo/go4/GO40033_Pinsonneault.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40033*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Soderblom
  ...
  <td>
  FLARING G STARS IN THE KEPLER FIELD: A DEEPER PHYSICAL UNDERSTANDING
  </td>
  <td>
<a href="data/keplergo/go4/GO40034_Soderblom.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40034*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Kawaler
  ...
  <td>
SPIN SYNCHRONIZATION AND ASTEROSEISMOLOGY OF THE SDB+DM BINARY B4 IN
NGC 6791
</td>
  <td>
<a href="data/keplergo/go4/GO40035_Kawaler.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40035*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Sandquist
  ...
  <td>
PRECISION STAR AGES USING DETACHED ECLIPSING BINARIES IN THE KEPLER
STAR CLUSTERS
</td>
  <td>
<a href="data/keplergo/go4/GO40036_Sandquist.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40036*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Fanelli
  ...
  <td>
A KEPLER GALAXY SURVEY: ESTABLISHING THE TEMPORAL BASELINE FOR
EXTRAGALACTIC SYSTEMS
</td>
  <td>
<a href="data/keplergo/go4/GO40037_Fanelli.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40037*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Wood
  ...
  <td>
<a href="data/keplergo/go4/GO40038_Wood.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40038*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Lovekin
  ...
  <td>
  INVESTIGATING THE PULSATION CHARACTERISTICS OF HOT VARIABLE STARS
  </td>
  <td>
<a href="data/keplergo/go4/GO40039_Lovekin.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40039*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Edelson
  ...
  <td>
  KEPLER MONITORING OF RAPID OPTICAL VARIABILITY IN AGN - CYCLE 4
  </td>
  <td>
<a href="data/keplergo/go4/GO40041_Edelson.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40041*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Montgomery
  ...
  <td>
MAPPING THE CONVECTION ZONES OF GAMMA DORADUS AND DELTA SCUTI
VARIABLES
</td>
  <td>
<a href="data/keplergo/go4/GO40042_Montgomery.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40042*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Saar
  ...
  <td>
EVOLUTION OF CRITICAL MAGNETIC CYCLE PARAMETERS WITH STELLAR AGE:
  DIFFERENTIAL ROTATION AND ACTIVE REGION DECAY RATES IN KEPLER
  CLUSTERS NGC 6811 (1 GYR) AND 6819 (2.5 GYR)
  </td>
  <td>
<a href="data/keplergo/go4/GO40043_Saar.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40043*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Papics
  ...
  <td>
<a href="data/keplergo/go4/GO40044_Papics.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40044*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Bochanski
  ...
  <td>
DANCING IN THE STELLAR GRAVEYARD: KEPLER ULTRA-HIGH PRECISION
OBSERVATIONS OF WHITE DWARF-M DWARF BINARIES
</td>
  <td>
<a href="data/keplergo/go4/GO40045_Bochanski.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40045*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Garnavich
  ...
  <td>
<a href="data/keplergo/go4/GO40046_Garnavich.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40046*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Jackiewicz
  ...
  <td>
INFLUENCE OF TIDAL FORCES ON SOLAR-LIKE OSCILLATIONS OF RED GIANTS IN
BINARY SYSTEMS
</td>
  <td>
<a href="data/keplergo/go4/GO40047_Jackiewicz.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40047*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Janes
  ...
  <td>
TESTING GYROCHRONOLOGY: KEPLER OBSERVATIONS OF COMMON PROPER MOTION
PAIRS
</td>
  <td>
<a href="data/keplergo/go4/GO40048_Janes.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40048*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Winget
  ...
  <td>
<a href="data/keplergo/go4/GO40050_Winget.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40050*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Lipscy
  ...
  <td>
  VARIABILITY IN OH/IR STARS WITHIN THE KEPLER FIELD
  </td>
  <td>
<a href="data/keplergo/go4/GO40051_Lipscy.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40051*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Brown
  ...
  <td>
ACTIVITY CYCLES AND STARSPOT EVOLUTION ON LATE-TYPE STARS IN THE
KEPLER FIELD (CYCLE 4)
</td>
  <td>
<a href="data/keplergo/go4/GO40053_Brown.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40053*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Thompson
  ...
  <td>
HEARTBEAT STARS: A NEW CLASS OF BINARY SYSTEM WITH EXTREME PERIASTRON
BRIGHTENINGS AND TIDALLY EXCITED MODES
</td>
  <td>
<a href="data/keplergo/go4/GO40056_Thompson.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40056*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Olling
  ...
  <td>
MILLIMAGNITUDE VARIABILITY OF GALAXIES IN THE KEPLER FIELD: GOING FOR
THE BREAK
</td>
  <td>
<a href="data/keplergo/go4/GO40057_Olling.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40057*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Peters
  ...
  <td>
  HOT SPOT MIGRATION AND PULSATION IN ALGOL-TYPE INTERACTING BINARIES
  </td>
  <td>
<a href="data/keplergo/go4/GO40058_Peters.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40058*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Orosz
  ...
  <td>
  COMPLETING THE KEPLER SURVEY OF BRIGHT K AND M DWARFS
  </td>
  <td>
<a href="data/keplergo/go4/GO40062_Orosz.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40062*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Quintana
  ...
  <td>
  MEASURING FLARE RATES AND ENERGIES OF LOW MASS STARS
  </td>
  <td>
<a href="data/keplergo/go4/GO40063_Quintana.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40063*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
Peterson
  ...
  <td>
ECLIPSING BINARIES AND THE SPATIAL EXTENT OF THE OLD OPEN CLUSTER NGC
6791
</td>
  <td>
<a href="data/keplergo/go4/GO40064_Peterson.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  <td>
	  <a
	  href="http://archive.stsci.edu/kepler/data_search/search.php?action=Search&max_records=100000&verb=3&ktc_target_type[]=LC&ktc_target_type[]=SC&ktc_investigation_id=*GO40064*"
	  class="btn btn-primary btn-xs"><i class="fa fa-download
	  fa-margin"></i> data</a>
  </td>
  </tr>
...
<div class="panel panel-primary">
  <div class="panel-heading">
    <h3 class="panel-title">Cycle 1 Participating Scientist Programs</h3>
  </div>
  <div class="panel-body">
...
DETECTION OF EXTRASOLAR PLANETS AROUND ECLIPSING BINARIES IN THE KEPLER FIELD
  ...
  <td>
<a href="data/keplerpsp/c1/c1_Doyle.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
 </tr>
...
CHARACTERIZING THE ORBITAL ECCENTRICITIES OF EARTH-LIKE PLANETS WITH KEPLER
  ...
  <td>
<a href="data/keplerpsp/c1/c1_Ford.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
GIANT PLANET SCIENCE FROM THE KEPLER MISSION
  ...
  <td>
<a href="data/keplerpsp/c1/c1_Fortney.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
APPLYING THE METHOD OF TRANSIT TIMING VARIATIONS TO KEPLER
  ...
  <td>
<a href="data/keplerpsp/c1/c1_Holman.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
THEORETICAL INTERPRETATION OF KEPLER EXOPLANET ALBEDOS AND REFLECTED LIGHT CURVES
  ...
  <td>
<a href="data/keplerpsp/c1/c1_Seager.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
DETECTING ADDITIONAL PLANETS IN TRANSITING SYSTEMS USING TRANSIT TIMING VARIATIONS
  ...
  <td>
<a href="data/keplerpsp/c1/c1_Steffen.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
DETAILED MODELLING OF EXTRASOLAR PLANET TRANSIT OBSERVATIONS AS A KEPLER PARTICIPATING SCIENTIST
  ...
  <td>
<a href="data/keplerpsp/c1/c1_Welsh.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
<div class="panel panel-primary">
  <div class="panel-heading">
    <h3 class="panel-title">Cycle 2 Participating Scientist Programs</h3>
  </div>
  <div class="panel-body">
...
VALIDATING KEPLER'S HABITABLE-ZONE SUPER-EARTHS WITH THE SPITZER SPACE TELESCOPE
  ...
  <td>
<a href="data/keplerpsp/c2/c2_Charbonneau.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
CHARACTERIZING THE ORBITAL ECCENTRICITIES OF EARTH-SIZE PLANETS AND ARCHITECTURES OF PLANETARY SYSTEMS WITH KEPLER
  ...
  <td>
<a href="data/keplerpsp/c2/c2_Ford.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
APPLYING THE METHOD OF TRANSIT TIMING VARIATIONS TO KEPLER: PHASE 2
  ...
  <td>
<a href="data/keplerpsp/c2/c2_Holman.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
DISCOVERY OF SHORT-PERIOD NON-TRANSITING PLANETS/BROWN-DWARF/LOW-MASS-STELLAR COMPANIONS THROUGH THE BEAMING (DOPPLER BOOSTING) EFFECT IN KEPLER LIGHTCURVES
  ...
  <td>
<a href="data/keplerpsp/c2/c2_Mazeh.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
THOROUGH UNDERSTANDING OF FOREGROUND AND BACKGROUND ECLIPSING BINARY STAR POPULATIONS OBSERVED BY KEPLER
  ...
  <td>
<a href="data/keplerpsp/c2/c2_Prsa.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
UNIFORM MODELING OF KEPLER OBJECTS OF INTEREST
  ...
  <td>
<a href="data/keplerpsp/c2/c2_Rowe.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
CHARACTERIZING PLANETARY SYSTEMS: CHEMICAL ABUNDANCES OF KEPLER STARS FROM KECK/HIRES FOLLOW-UP SPECTROSCOPY
  ...
  <td>
<a href="data/keplerpsp/c2/c2_Schuler.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
DETECTING AND CHARACTERIZING PLANETARY SYSTEMS WITH TRANSIT TIMING VARIATIONS
  ...
  <td>
<a href="data/keplerpsp/c2/c2_Steffen.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
TESTING KEPLER ASTROMETRY WITH OUR NEAREST NEIGHBORS
  ...
  <td>
<a href="data/keplerpsp/c2/c2_Tanner.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
VALIDATION OF KEPLER CANDIDATE TRANSITING PLANETS WITH BLENDER
  ...
  <td>
<a href="data/keplerpsp/c2/c2_Torres.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
DETAILED MODELING OF EXOPLANET TRANSITS
  ...
  <td>
<a href="data/keplerpsp/c2/c2_Welsh.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
OBLIQUITIES OF KEPLER STARS: CLUES TO PLANET MIGRATION
  ...
  <td>
<a href="data/keplerpsp/c2/c2_Winn.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
<div class="panel panel-primary">
  <div class="panel-heading">
    <h3 class="panel-title">Cycle 3 Participating Scientist Programs</h3>
  </div>
  <div class="panel-body">
...
TOWARDS ETA-EARTH: CHARACTERIZING THE DETECTION RATE OF SMALL PLANETS IN THE KEPLER PIPELINE
  ...
  <td>
<a href="data/keplerpsp/c3/c3_Christiansen.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
DEEP AO IMAGING VALIDATION OF KOI'S USING THE LARGE BINOCULAR TELESCOPE
  ...
  <td>
<a href="data/keplerpsp/c3/c3_Crepp.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
CHARACTERIZATION OF THE STELLAR POPULATION IN THE KEPLER FIELD: PUTTING KEPLER'S SMALL PLANETS INTO A GALACTIC CONTEXT
  ...
  <td>
<a href="data/keplerpsp/c3/c3_Endl.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
THE ARCHITECTURES OF EXTRASOLAR TERRESTRIAL SYSTEMS
  ...
  <td>
<a href="data/keplerpsp/c3/c3_Fabrycky.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
ACCURATE FUNDAMENTAL PROPERTIES OF KEPLER TARGET STARS
  ...
  <td>
<a href="data/keplerpsp/c3/c3_Huber.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
COMPLETING THE KEPLER CENSUS OF EARTH-LIKE PLANETS
  ...
  <td>
<a href="data/keplerpsp/c3/c3_Morton.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
A DEEP SEARCH FOR SMALL PLANETS AND MULTIPLE SYSTEMS USING THE SARS PIPELINE
  ...
  <td>
<a href="data/keplerpsp/c3/c3_Ofir.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
UNIFORM MODELING OF KEPLER OBJECTS OF INTEREST
  ...
  <td>
<a href="data/keplerpsp/c3/c3_Rowe.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
CONFIRMING SMALL PLANETS AND MEASURING THEIR MASSES WITH TRANSIT TIMING VARIATIONS
  ...
  <td>
<a href="data/keplerpsp/c3/c3_Steffen.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
VALIDATION OF SMALL KEPLER CANDIDATE TRANSITING PLANETS WITH BLENDER
  ...
  <td>
<a href="data/keplerpsp/c3/c3_Torres.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
...
CIRCUMBINARY HABITABLE ZONE PLANETS
  ...
  <td>
<a href="data/keplerpsp/c3/c3_Welsh.pdf" class="btn
      btn-primary btn-xs"><i class="fa fa-download fa-margin"></i>
      abstract</a>
  </td>
  </tr>
