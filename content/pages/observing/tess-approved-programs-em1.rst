Selected Targets from General Investigator programs during the first extension
##############################################################################
:save_as: approved-programs-em1.html

.. contents::

This page details the targets selected from `General Investigator programs <proposing-investigations.html>`_ that were observed by TESS during the first extension of its mission (July 2020-September 2022).
...
.. raw:: html
    ...
    <ul class="list-group">
        <li class="list-group-item">
          ...
          August 05, 2022 - September 01, 2022
        </li>
        <li class="list-group-item">
            <i class="fa fa-download fa-margin"></i>
            <a href="data/target_lists/sector055_targets_lists/GI_S055.csv">2 min target list (csv)</a>, 
            <a href="data/target_lists/sector055_targets_lists/GI_20s_S055.csv">20 s target list (csv)</a>
        </li>
    </ul>

.. include:: approved-programs/sector055.html
...
.. include:: approved-programs/sector054.html
