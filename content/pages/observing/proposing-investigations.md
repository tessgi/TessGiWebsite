...
The TESS Guest Investigator (GI) program is intended to enable the community to participate in science investigations using TESS. The program enables teams to propose: the collection of new 2-minute and 20-second cadence targets; provides funding to US investigators to analyze 2-minute and 20-second cadence and full-frame image (FFI) data; and provide funding for US investigators to collect ground-based data that supports TESS science. All proposals are managed by the [GI office](helpdesk.html).
...
<table class="table table-striped table-hover" style="max-width:55em;">
  ...
  <tr>
    <td style="width: 15em;">
     Cycle 4 <a href="proposal-templates.html">proposal templates</a> are available. Their use is optional.</td>
  </tr>

  <tr>
    <td style="width: 15em;">
     The <a href="https://heasarc.gsfc.nasa.gov/cgi-bin/tess/webtess/wtv.py">Web TESS Viewing (WTV)</a> tool allows checking of whether a target falls within the TESS field of view, is currently being updated for Cycle 4. The downloadable software, <a href="https://github.com/christopherburke/tess-point">TESS-Point</a> can also be used to check on the observability of targets.</td>
  </tr>
...
No Key projects are solicited in Cycle 4.
...
Due to the extended length of Cycle 4 compared to previous cycles, the total amount of funding available to U.S.-based PIs through this solicitation has been increased to $3.4M. TESS 2-minute and 20-second cadence observations are open to all scientists at U.S. or non-U.S. institutions. TESS GI funding is open to all individuals who are identified as Principal Investigators and employed at U.S. institutions. 
...
Up to $500,000 will be awarded to ground-based observing focused projects.
...
From Cycle 4 onwards all proposals are subject to a dual-anonymous peer review. The aim of a dual-anonymous peer review is to reduce unconscious bias in the evaluation of the merit of a proposal. 
